...
public class FileUtil {
	 ...
	 * Files\\Test.doc' is passed in, 'Test.doc' is returned. Alsoe takes care
	 * of / slashes in the case of /Program Files/Test.doc'
	 *
	 * @param fullFileName
	...
	public static File createDir(String dir) throws IOException {
		...
		if (!tmpDir.exists()) {
			...
			// System.out.println("Not creating directory, " + dir + ", this
	 ...
	 * @return <code>true</code> if all deletions successful, <code>false>
	 *         otherwise
	 */
