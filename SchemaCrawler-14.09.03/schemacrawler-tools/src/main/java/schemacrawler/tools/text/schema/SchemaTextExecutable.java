  ...
  extends BaseStagedExecutable
{
    ...
    throws SchemaCrawlerException
  {
    ...
    if (outputFormat == TextOutputFormat.metadataxml)
    {
      formatter = new SchemaMetadataFormatter(schemaTextDetailType,
                                              schemaTextOptions,
                                              outputOptions);
    }
    else if (outputFormat == TextOutputFormat.xml)
    {
      formatter = new SchemaXMLFormatter(schemaTextDetailType,
                                         schemaTextOptions,
                                         outputOptions);
    }
