  ...
  extends BaseTextOptions
{
  ...
  private boolean isFullMetadataFile;
  private boolean isShowRelationship;
  ...
  public void setShowRelationship(final boolean isShowRelationship)
  {
    this.isShowRelationship = isShowRelationship;
  }

  public boolean isFullMetadataFile()
  {
    return isFullMetadataFile;
  }

  public void setFullMetadataFile(boolean isFullMetadataFile)
  {
    this.isFullMetadataFile = isFullMetadataFile;
  }
