  ...
  implements Iterable<String>
{
  ...
  private static Map<String, DatabaseConnector1> loadDatabaseConnectorRegistry()
    throws SchemaCrawlerException
  {

    final Map<String, DatabaseConnector1> databaseConnectorRegistry = new HashMap<>();

    try
    {
      final ServiceLoader<DatabaseConnector1> serviceLoader = ServiceLoader
        .load(DatabaseConnector1.class);
      for (final DatabaseConnector1 databaseConnector: serviceLoader)
      {
  ...
  private final Map<String, DatabaseConnector1> databaseConnectorRegistry;
  ...
  public DatabaseConnector1 lookupDatabaseConnector(final Connection connection)
  {
    try
    {
    ...
    {
      return DatabaseConnector1.UNKNOWN;
    }
  }

  public DatabaseConnector1 lookupDatabaseConnector(final String databaseSystemIdentifier)
  {
  ...
  public DatabaseConnector1 lookupDatabaseConnectorFromUrl(final String url)
  {
    if (isBlank(url))
    {
      return DatabaseConnector1.UNKNOWN;
    ...
    for (final DatabaseConnector1 databaseConnector: databaseConnectorRegistry
      .values())
    {
