...
public abstract class DatabaseConnector1
  implements Options
{

  private static final long serialVersionUID = 6133330582637434099L;

  protected static final DatabaseConnector1 UNKNOWN = new DatabaseConnector1()
  {
  ...
  protected DatabaseConnector1(final DatabaseServerType dbServerType,
